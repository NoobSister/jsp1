...
<body>
	<!-- request 객체의 애트리뷰트를 이용하여 
		  ...
		  그리고 이 때, A.jsp 파일로 이동하는 명령은 pageContext.forword("A.jsp") 로 합니다.
	 ...
	 <%
	 	...
	 	int value1 = 23;
	 	String value2 = "Hello";
	 	out.print(value2);		// pageContext.forword 요청이 넘어가면 현재 페이지 출력내용은 확인이 안됩니다.
	 	
	 	// 위의 3가지 값은 request_result.jsp 파일로 전달합니다.
	 	request.setAttribute("attr1", vo);	// setAttribute 에서 attr1은 애트리뷰트 key, vo는 애트리뷰트값
	 	...
	 	// 요청을 변경하는 게 아니고 요청을 전달(forword)합니다. -> 요청이 발생했을 때의 request 객체 정보를 똑같이 사용할 수 있게 합니다.
